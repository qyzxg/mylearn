...
print(pytesseract.image_to_string(Image.open('1.jpg'), config=tessdata_dir_config))
...
def code():
    ...
    with open('./code/{}.gif'.format(uuid.uuid1()), 'wb') as code_:
        code_.write(code_r.content)
